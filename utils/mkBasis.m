...
if strcmp(basisType, 'fast')
    ...
    scale1 = 0.01;
    scale3 = 1;
elseif strcmp(basisType, 'fast_gevi')
    scale2 = 1.15;%1.154;
    const = 0.00009;
    scale1 = 0.01;
    scale3 = 1;
...
elseif strcmp(basisType, 'slow')
    ...
    scale1 = 0.006;
    scale3 = .99;
elseif strcmp(basisType, 'slow_gevi')
    scale2 = 1.105;%0.95;%1.125;
    const  = 0.0013;
    scale1 = 0.006;
    scale3 = .99;
...
elseif strcmp(basisType, 'slow_vsd2')
    scale2 = 1.105;%0.95;%1.125;
    const  = 0.0013;
    scale1 = 0.006;
    scale3 = .99;
elseif strcmp(basisType, 'slow_longdt')
    scale2 = 1.135;%0.95;%1.125;
    const  = 0.0013;
    scale1 = 0.006;
    scale3 = .99;

elseif strcmp(basisType, 'fast_longdt')
    scale2 = 1.18;%1.154;
    const = 0.00009;
    scale1 = 0.01;
    scale3 = 1;
...
if strcmp(basisType, 'fast') | strcmp(basisType, 'gcamp') | strcmp(basisType, 'fast_longdt') 
    basis = [zeros(nbasis, 1), basis(:, 1 : length(t) - 1)];
end

%% for slow basis

if strcmp(basisType, 'slow') | strcmp(basisType, 'slow_alternative') | strcmp(basisType, 'slow_gevi')| strcmp(basisType, 'slow_vsd2') | strcmp(basisType, 'slow_longdt')
    basis = fliplr(basis);
